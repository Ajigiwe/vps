...
class Subscription(Base, UUIDPrimaryKeyMixin, TimestampMixin):
    ...
    cpu_allocated: Mapped[int] = mapped_column(Integer, nullable=False)
    ram_allocated: Mapped[int] = mapped_column(Integer, nullable=False)
...
class CustomerEnvironment(Base, UUIDPrimaryKeyMixin, TimestampMixin):
    ...
    ram_limit_gb: Mapped[int] = mapped_column(Integer, nullable=False)
